Ext.define('App.controller.core.locale.LocaleDe', {
    doTranslation : function() {
        if(Ext.Updater) {
            Ext.Updater.defaults.indicatorText = '<div class="loading-indicator">&Uuml;bertrage Daten ...</div>';
        }
        ...
        if(Ext.grid.Panel){
            Ext.grid.Panel.prototype.ddText = "{0} Zeile(n) ausgew&auml;hlt";
        }
        ...
        if(Ext.LoadMask){
            Ext.LoadMask.prototype.msg = "&Uuml;bertrage Daten...";
        }
        ...
        if(Ext.picker.Date){
            Ext.apply(Ext.picker.Date.prototype, {
                todayText         : "Heute",
                minText           : "Dieses Datum liegt vor dem erstm&ouml;glichen Datum",
        ...
        if(Ext.toolbar.Paging){
            Ext.apply(Ext.PagingToolbar.prototype, {
                ...
                displayMsg     : "Zeige Eintr&auml;ge {0} - {1} von {2}",
        ...
        if(Ext.form.field.Date){
            Ext.apply(Ext.form.field.Date.prototype, {
                ...
                invalidText       : "{0} ist kein g&uuml;ltiges Datum - es muss im Format {1} eingegeben werden",
                format            : "d.m.Y",
        ...
        if(Ext.form.field.HtmlEditor){
            Ext.apply(Ext.form.field.HtmlEditor.prototype, {
                createLinkText : 'Bitte geben Sie die URL f&uuml;r den Link ein:',
                buttonTips : {
                    bold : {
                        title: 'Fett (Ctrl+B)',
                        text: 'Erstellt den ausgew&auml;hlten Text in Fettschrift.',
                        cls: Ext.baseCSSPrefix + 'html-editor-tip'
                    },
                    italic : {
                        title: 'Kursiv (Ctrl+I)',
                        text: 'Erstellt den ausgew&auml;hlten Text in Schr&auml;gschrift.',
                        cls: Ext.baseCSSPrefix + 'html-editor-tip'
                    },
                    underline : {
                        title: 'Unterstrichen (Ctrl+U)',
                        text: 'Unterstreicht den ausgew&auml;hlten Text.',
                        cls: Ext.baseCSSPrefix + 'html-editor-tip'
                    },
                    increasefontsize : {
                        title: 'Text verg&ouml;ssern',
                        text: 'Erh&ouml;ht die Schriftgr&ouml;&szlig;e.',
                        cls: Ext.baseCSSPrefix + 'html-editor-tip'
                    },
                    decreasefontsize : {
                        title: 'Text verkleinern',
                        text: 'Verringert die Schriftgr&ouml;&szlig;e.',
                        cls: Ext.baseCSSPrefix + 'html-editor-tip'
                    },
                    backcolor : {
                        title: 'Text farblich hervorheben',
                        text: 'Hintergrundfarbe des ausgew&auml;hlten Textes &auml;ndern.',
                        cls: Ext.baseCSSPrefix + 'html-editor-tip'
                    },
                    forecolor : {
                        title: 'Schriftfarbe',
                        text: 'Farbe des ausgew&auml;hlten Textes &auml;ndern.',
                        cls: Ext.baseCSSPrefix + 'html-editor-tip'
                    },
                    justifyleft : {
                        title: 'Linksb&uuml;ndig',
                        text: 'Setzt den Text linksb&uuml;ndig.',
                        cls: Ext.baseCSSPrefix + 'html-editor-tip'
                    },
                    justifycenter : {
                        title: 'Zentrieren',
                    ...
                    justifyright : {
                        ...
                        text: 'Setzt den Text rechtsb&uuml;ndig.',
                        cls: Ext.baseCSSPrefix + 'html-editor-tip'
                    },
                    insertunorderedlist : {
                        title: 'Aufz&auml;hlungsliste',
                        text: 'Beginnt eine Aufz&auml;hlungsliste mit Spiegelstrichen.',
                        cls: Ext.baseCSSPrefix + 'html-editor-tip'
                    },
                    insertorderedlist : {
                    ...
                    createlink : {
                        title: 'Hyperlink',
                        text: 'Erstellt einen Hyperlink aus dem ausgew&auml;hlten text.',
                        cls: Ext.baseCSSPrefix + 'html-editor-tip'
                    },
                    sourceedit : {
        ...
        if(Ext.form.field.Time){
            Ext.apply(Ext.form.field.Time.prototype, {
                ...
                invalidText : "{0} ist keine g&uuml;ltige Zeit",
                format : "H:i"
            });
        }
        ...
        if(Ext.form.CheckboxGroup){
            Ext.apply(Ext.form.CheckboxGroup.prototype, {
                blankText : "Du musst mehr als einen Eintrag aus der Gruppe ausw&auml;hlen"
            });
        }

        if(Ext.form.RadioGroup){
            Ext.apply(Ext.form.RadioGroup.prototype, {
                blankText : "Du musst einen Eintrag aus der Gruppe ausw&auml;hlen"
            });
        }
    }
});
